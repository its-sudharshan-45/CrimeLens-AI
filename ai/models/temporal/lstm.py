"""
ai/models/temporal/lstm.py
===========================
Standard LSTM Time Series Forecaster for CrimeLens AI (Phase 3).

Architecture:
    Input: (batch_size, seq_len=30, input_size=13)
       ↓
    LSTM(input_size=13, hidden_size=64, num_layers=2, dropout=0.2, batch_first=True)
       ↓
    Dropout(0.2)
       ↓
    Dense / Linear(64, 7)
...
Designed for academic reproducibility and clear temporal deep learning demonstration.
"""
...
class CrimeLSTMForecaster(nn.Module):
    """
    Standard LSTM multi-step crime count forecaster.
    ...
    def forward(
        ...
        Args:
            ...
            hx: Optional initial hidden and cell state tuple
